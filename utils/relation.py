...
def extract_term_relation(
    ...
    "reason"字段的内容要求如下：
    1. 如果关系为因果关系或从属关系，请在"reason"中填入引入文档的原文
    2. 如果关系为非因果非从属关系，请在"reason"中填入空字符串。

    "documents"的内容要求如下：
    1. 如果关系为因果关系或从属关系，请在"documents"中填入引入文档的标题；
    2. 如果关系为非因果非从属关系，请将"documents"设为空字符串。

    "page"的内容要求如下：
    1. 如果关系为因果关系或从属关系，请在"page"中填入引入文档的页码；
    2. 如果关系为非因果非从属关系，请将"page"设为0。
"""
